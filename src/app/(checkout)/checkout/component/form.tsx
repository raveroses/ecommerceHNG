const Form = () => {
  return (
    <form>
      <div className="firstForm flex justify-between md:flex-row flex-col">
        <div className="  ">
          <div className="flex justify-between pb-[10px]">
            ...
            <p className="text-[12px] leading-[100%] tracking-[-0.21px] font-[700]">
              Wrong Format
            </p>
          </div>
          <input
            ...
            id="name"
            name="name"
            className=" md:w-[309px] w-full h-[56px] rounded-[8px] border-1 border-[#D87D4A]"
          />
        </div>
        <div >
          <div className="flex justify-between pb-[10px]">
      ...
      <div className="thirdInput pt-[30px]">
        ...
        <div>
          ...
          <input
            ...
            name="address"
            id="address"
            className="md:w-[634px] w-full h-[56px] border-1 border-[#CFCFCF] rounded-[8px] "
          />
        </div>
      </div>

      <div className="fourthForm flex justify-between  md:flex-row flex-col  pt-[30px]">
        <div>
          <div className="flex justify-between pb-[10px]">
            <label
              htmlFor="zip"
      ...
      <div className="Fifth Input pt-[30px] ">
        <div >
          <div className="flex justify-between pb-[10px]">
            <label
              htmlFor="country"
      ...
      <div className="lastInput pt-[30px]">
        ...
        <div className="flex flex-col gap-[20px] md:ml-[330px]">
          <div className="md:w-[309px] w-full h-[56px] border-1 border-[#D87D4A] rounded-[8px] p-[15px] flex gap-[10px] items-center">
            <input type="radio" name="Money" id="Money" />
            <label
              htmlFor="Money"
              className="text-[14px] leading-[100%] tracking-[-0.25px] font-[700]"
            >
              e-Money
            </label>
          </div>
