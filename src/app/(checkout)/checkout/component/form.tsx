const Form = () => {
  return (
    <form className="relative">
      <div className="firstForm flex justify-between">
        <div className="w-[309px] h-[81px] ">
          ...
          <input
            ...
            id="name"
            name="name"
            className=" w-[309px] h-[56px] rounded-[8px] border-1 border-[#D87D4A]"
          />
        </div>
        <div className="w-[309px] h-[81px] ">
          <div className="flex justify-between pb-[10px]">
      ...
      <div className="thirdInput pt-[30px]">
        ...
        <div className="w-[634px] h-[81px] pt-[30px]">
          <div className="flex justify-between pb-[10px]">
            <label
              htmlFor="address"
              className="text-[12px] leading-[100%] tracking-[-0.21px] font-[700]"
          ...
          <input
            ...
            name="address"
            id="address"
            className="w-[634px] h-[56px] border-1 border-[#CFCFCF] rounded-[8px] "
          />
        </div>
      </div>

      <div className="fourthForm flex justify-between pt-[30px]">
        <div className="w-[309px] h-[81px] ">
          <div className="flex justify-between pb-[10px]">
            <label
              htmlFor="zip"
      ...
      <div className="lastInput pt-[30px]">
        ...
        <div className="flex flex-col gap-[20px] ml-[330px]">
          <div className="w-[309px] h-[56px] border-1 border-[#D87D4A] rounded-[8px] p-[15px] flex gap-[10px] items-center">
